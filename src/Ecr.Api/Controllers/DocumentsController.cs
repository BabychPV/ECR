    ...
    ApplyImportHandler applyImport) : ControllerBase
{
    ...
    /// <c>SheetDefId</c> звужує перерахунок до одного аркуша (Q-330); без нього —
...
/// <summary>Запит на перерахунок документа (Q-330).</summary>
/// <param name="PeriodKey">Період; <c>Рік*100 + Номер</c> (R-A6).</param>
/// <param name="SheetDefId">
/// Аркуш; <c>null</c> — увесь документ (поведінка до Q-330). Заданий —
