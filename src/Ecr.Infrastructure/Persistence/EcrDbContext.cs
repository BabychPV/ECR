    ...
    : DbContext(options), IDataProtectionKeyContext
{
    ...
    protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
    {
        ...
        // decimal(28,16) скрізь: точність задається один раз, а не забувається
        ...
        // неможливою (D-30).
        //
        // ⚠ 16, а не 10 (`D-148`). Конвенція переведена ПІСЛЯ трьох міграцій
        // типів і навмисно останньою: усі тринадцять стовпців вимірюваних
        // величин оголошені явно, тож ця зміна не мусить давати жодної нової
        // міграції — і порожній `dotnet ef migrations add` після неї це й
        // доводить. Зроби її першою — і кожна наступна міграція несла б
        // фасети, яких ніхто не замовляв.
        //
        // ⚠ Precision лишається 28: ширина `decimal` у SQL Server залежить
        // ЛИШЕ від неї, тож 16 знаків замість 10 коштують нуль байтів на рядок.
        // Ціна інша — 12 цілих розрядів замість 18.
        configurationBuilder.Properties<decimal>().HavePrecision(28, 16);
