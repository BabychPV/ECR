...
namespace Ecr.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921194433_BE08JobProgressCreatedErrorDocument")]
    partial class BE08JobProgressCreatedErrorDocument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Calculations.CalculationStep", b =>
                {
                    ...
                    b.Property<byte>("Masked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint")
                        .HasDefaultValue((byte)0)
                        .HasColumnName("MaskedZero");
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Calculations.MethodologyConstant", b =>
                {
                    ...
                    b.Property<string>("CategoryNorm")
                        .IsRequired()
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("nvarchar(450)")
                        .HasComputedColumnSql("ISNULL([Category], N'')", true);
                    ...
                    b.Property<DateOnly>("ValidFromNorm")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("date")
                        .HasComputedColumnSql("ISNULL([ValidFrom], CONVERT(date, '19000101', 112))", true);
                    ...
                    b.HasIndex("MethodologyVersionId", "Code", "CategoryNorm", "ValidFromNorm")
                        .IsUnique()
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Calculations.MethodologyRequiredInput", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MethodologyVersionId", "ColumnDefId")
                        .IsUnique()
                        .HasDatabaseName("UQ_MethodologyRequiredInput");

                    b.ToTable("MethodologyRequiredInput", "calc");
                });
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Configuration.RegistryRuleDef", b =>
                {
                    ...
                    b.Property<bool>("IsActive")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true, "DF_RegRule_Act");

                    b.Property<string>("MessageL10n")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("MessageL10n");
                    ...
                    b.HasIndex("RegistryDefId", "Code")
                        .IsUnique()
                        .HasDatabaseName("UQ_RegistryRuleDef");
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Integration.ScanCursor", b =>
                {
                    ...
                    b.HasKey("ScanCode")
                        .HasName("PK_ScanCursor");

                    b.ToTable("ScanCursor", "itg");
                });

            modelBuilder.Entity("Ecr.Domain.Entities.Notifications.NotificationChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte[]>("SecretProtected")
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("UQ_NotificationChannel_Name");

                    b.ToTable("NotificationChannel", "sys_ecr", t =>
                        {
                            t.HasCheckConstraint("CK_NotificationChannel_Kind", "Kind IN (1, 2)");
                        });
                });
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Notifications.NotificationDelivery", b =>
                {
                    ...
                    b.HasIndex("ChannelId", "EventKey", "At")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("IX_NotificationDelivery_Dedup");

                    b.ToTable("NotificationDelivery", "itg", t =>
                        {
                            t.HasCheckConstraint("CK_NotificationDelivery_Status", "Status IN (1, 2, 3)");
                        });
                });
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Notifications.NotificationRule", b =>
                {
                    ...
                    b.HasIndex("ChannelId")
                        .HasDatabaseName("IX_NotificationRule_Channel");

                    b.HasIndex("EventKind", "ChannelId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Security.RoleAssignment", b =>
                {
                    ...
                    b.HasIndex("PrincipalSid", "RoleId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Workflow.ApprovalEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DocumentId", "PeriodKey", "At")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("IX_ApprovalEvent_Document");

                    b.ToTable("ApprovalEvent", "wf");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.DataProtection.EntityFrameworkCore.DataProtectionKey", b =>
                {
                    ...
                    b.ToTable("DataProtectionKey", "sec");
                });
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Configuration.ColumnDef", b =>
                {
                    b.HasOne("Ecr.Domain.Entities.Configuration.ColumnDef", null)
                        .WithMany()
                        .HasForeignKey("CascadeFromColumnId")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Configuration.TableRelationDef", b =>
                {
                    b.HasOne("Ecr.Domain.Entities.Configuration.TableDef", null)
                        .WithMany()
                        .HasForeignKey("SourceTableDefId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("Ecr.Domain.Entities.Configuration.TableDef", null)
                        .WithMany()
                        .HasForeignKey("TargetTableDefId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Documents.Project", b =>
                {
                    b.HasOne("Ecr.Domain.Entities.Documents.Period", null)
                        .WithMany()
                        .HasForeignKey("CurrentPeriodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_Project_CurrentPeriod");

                    b.HasOne("Ecr.Domain.Entities.Documents.PeriodPolicy", null)
                        .WithMany()
                        .HasForeignKey("PeriodPolicyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Security.User", b =>
                {
                    b.HasOne("Ecr.Domain.Entities.Security.PasswordPolicy", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ecr.Domain.Entities.Units.Dimension", b =>
                {
                    ...
                    b.HasOne("Ecr.Domain.Entities.Units.Dimension", null)
                        .WithMany()
                        .HasForeignKey("DenominatorDimensionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_Dim_Den");

                    b.HasOne("Ecr.Domain.Entities.Units.Dimension", null)
                        .WithMany()
                        .HasForeignKey("NumeratorDimensionId")
                        .OnDelete(DeleteBehavior.Restrict)
