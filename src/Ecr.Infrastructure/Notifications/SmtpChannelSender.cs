...
/// `ФВ-6.11`), а КАНАЛ дає адресатів і заголовок. Тому <c>settings.host</c> і
/// <c>settings.port</c> каналу цей відправник НЕ використовує: окремий
/// <c>SmtpClient</c> на канал означав би ще одне місце, де живуть облікові дані
/// пошти, і саме туди їх поклали б відкритим текстом.
///
