...
const Grandfathered = {
  DocumentPage: {
    ...
    until: 'UAT',
    why:
      'Знайдено цим гейтом у мить його появи: 258.6 КБ при межі 250. ' +
      'Причину зʼясовано (H-4, директива №06): RevoGrid — 79.1 % джерел ' +
      'чанка, наша логіка grid-редактора 17.8 %, Mantine 3.0 %. Ані Monaco, ' +
      'ані дубльованих залежностей у чанку немає, отже це НЕ регресія D-132. ' +
      'Ліки відомі: винести DocumentGrid у lazy() — ядро RevoGrid піде ' +
      'власним чанком. Строк — до виходу на UAT.',
  },
};
