...
export default defineConfig({
  ...
  test: {
     ...
     *
     * ⚠ У Node 22 (CI) `performance.now()` більше не йде через
     * `process.hrtime`, тому там ці ж файли були зелені, а на Node 18
     * (локально) — червоні. Тобто це НЕ «повільна машина»: результат
     * залежав від версії Node, а не від навантаження.
     *
