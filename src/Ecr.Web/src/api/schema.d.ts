...
export interface paths {
    ...
    "/api/v1/documents/{id}/recalculate": {
         ...
         *     `SheetDefId` звужує перерахунок до одного аркуша (Q-329); без нього —
...
export interface components {
    schemas: {
        ...
        /** @description Запит на перерахунок документа (Q-329). */
        RecalculateDocumentRequest: {
            ...
            /**
             * Format: int32
             * @description Аркуш; `null` — увесь документ (поведінка до Q-329). Заданий —
