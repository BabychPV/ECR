...
export interface paths {
    ...
    "/api/v1/documents/{id}/recalculate": {
         ...
         *     `SheetDefId` звужує перерахунок до одного аркуша (Q-328); без нього —
...
export interface components {
    schemas: {
        ...
        /** @description Запит на перерахунок документа (Q-328). */
        RecalculateDocumentRequest: {
            ...
            /**
             * Format: int32
             * @description Аркуш; `null` — увесь документ (поведінка до Q-328). Заданий —
