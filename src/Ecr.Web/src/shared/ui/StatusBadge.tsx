 ...
 * рамкою навколо чужого тексту. Сьогодні живих способів п'ять, і вони вже
 * розійшлися: `JobsPage.stateColor` малює невідомий стан синім,
 * `PeriodsPage.stateColor` — теж синім, але `Scheduled` у нього туди й
 * потрапляє; `SourcesPage` фарбує `Failed` у `statusWarning`; `HealthPage` має
 * власну трійку; `DocumentsPage` не фарбує взагалі й друкує сирий код.
 *
