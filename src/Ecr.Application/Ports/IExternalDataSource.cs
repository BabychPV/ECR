...
/// </summary>
/// <remarks>
/// ⚠ <b>Q-014, обґрунтування — слабке (здогадка).</b> Опису типу в пакеті немає.
/// Поля взяті з таблиці <c>ext.SourceEntity</c> (`02a-db-schema.md` рядок 1342):
/// <c>Code</c>, <c>DisplayName</c>, <c>EntityPath</c> — саме їх заповнює
/// «каталог сутностей джерела — для конфігуратора, щоб не вводити імена руками».
