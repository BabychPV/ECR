...
/// <summary>
/// Q-328: перерахунок з <c>SheetDefId</c> звужує прив'язки методологій
/// (<c>RecalculationJob.BindingsAsync</c>) до таблиць ЦЬОГО аркуша.
/// </summary>
/// <remarks>
/// ⛔ Директива паритету зі старою системою, прогалина 2 (Q-327 → Q-328):
...
public sealed class RecalculationJobSheetScopeTests(SqlServerFixture sql)
{
    ...
    {
        // ⚠ Контрольний тест: поведінка до Q-328 (`SheetDefId = null`)
