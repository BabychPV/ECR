...
/// цю величину до 2026-09-18 НІЩО: у `tz/08` числа не було, серед критеріїв
/// гейта BR-07 його не було, а в базі немає навіть мітки постановки —
/// `itg.JobProgress` створюється вже зі станом `Running`, тобто в момент
/// СТАРТУ. Стан `Queued` фігурує у фільтрах `JobProgressStore` і не пишеться
/// ніким.
///
