...
### `src/Ecr.Api/Errors/ErrorCodes.cs` — ПЕРЕЇХАВ

⛔ Каталог кодів живе в `src/Ecr.Domain/Errors/ErrorCodes.cs` (крок `II.5`,
`H-5`), а його опис — у [`05b-skeleton-domain.md`](05b-skeleton-domain.md)
§2. Під API він блокував доступ до себе двом шарам нижче, і ті писали коди
рядковими літералами повз каталог.

⚠ Тут його переліку більше немає і бути не повинно: саме друга копія в цьому
файлі колись розійшлася з кодом на п'ять кодів, і розійшлася непомітно.
