...
### Q-234 · SCOPE · Аудит зовнішнього збору (`Ecr.Adapters.PiAf`, `CollectionJob`/`MaterializeCollectedDataJob`, `NotificationJob`), 2026-09-11 · збір за розкладом не запускався ЖОДНОГО РАЗУ
