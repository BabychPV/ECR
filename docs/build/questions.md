...
| Q-028 | SCOPE | повний аудит Етапів 0–1 | RESOLVED · 1 відкритий пункт: `<path>` у `01-filegroups.sql` |
...
**Що потрібно від людини:** або підставити фактичні шляхи в `02a` (і тоді
скрипт перевитягнеться), або узгодити, що `01-filegroups.sql` — шаблон, який
DBA параметризує при розгортанні, і зафіксувати це в runbook.

**Статус:** RESOLVED · аудит виконано; один відкритий пункт винесено вище
