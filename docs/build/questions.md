...
| Q-153 | CONFLICT | періоди щойно створеного проєкту лишаються `Scheduled` до наступної години: `PeriodStateJob` виконується на старті застосунку і щогодини, тож новий проєкт не приймає жодного запису | OPEN |
| Q-154 | SCOPE | `S-21` недосяжний: формули шаблону і формули методологій — два різні конвеєри, і явного маршруту «перерахуй формули шаблону» в контракті немає | OPEN |
...
**Статус:** RESOLVED
### Q-153 · CONFLICT · Етап I · 2026-09-08 — новий проєкт годину не приймає жодного запису
...
### Q-154 · SCOPE · Етап I · 2026-09-08 — `S-21` недосяжний: два різні конвеєри перерахунку
