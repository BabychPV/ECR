...
| Q-147 | CONFLICT | другий вхід перерахунку (`RunCalculationHandler`) недосяжний з API і семантично несумісний із job, який ставить у чергу — payload без `DocumentId` | OPEN |
...
### Q-147 · CONFLICT · Етап I · 2026-09-08 — другий вхід перерахунку недосяжний і семантично не той
