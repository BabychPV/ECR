...
| Q-153 | SCOPE | зріз подання не несе версій методологій і режимів: `TemplateVersionId` виправлено, решта три поля пишуться підставними значеннями | OPEN |
| Q-154 | CONFLICT | `GET /jobs/{id}` вимагає `System.ViewHealth`: автор експорту чи перерахунку отримує `jobId`, за яким йому нічого не видно | OPEN |
| Q-155 | CONFLICT | два різні `ValidationMessageDto` зливаються в одну схему OpenAPI — згенерований клієнтський тип не знає про `blocksSave` | OPEN |
| Q-156 | CONFLICT | `MetadataCache` не вантажить `cfg.FormulaDef`: жодна формула шаблону не рахується, хоч граф залежностей і обчислювач працюють | OPEN |
...
### Q-153 · SCOPE · Етап I · 2026-09-08 — зріз подання не несе версій методологій і режимів
...
### Q-154 · CONFLICT · Етап I · 2026-09-08 — автор не може стежити за власною задачею
...
### Q-155 · CONFLICT · Етап I · 2026-09-08 — два різні `ValidationMessageDto` зливаються в одну схему OpenAPI
...
### Q-156 · CONFLICT · Етап I · 2026-09-08 — знімок метаданих не вантажить `FormulaDef`
