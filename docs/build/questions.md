...
| Q-160 | SCOPE | `S-21` недосяжний: формули шаблону і формули методологій — два різні конвеєри, і явного маршруту «перерахуй формули шаблону» в контракті немає | OPEN |
