...
| Q-083 | CONFLICT | підключення `DialectCatalog`: `CONVERT` робить версію несумісною з `Legacy`; копія одного рядка в `RealFormulaEngine` ховала цілу зміну | RESOLVED |
...
### Q-083 · CONFLICT · Етап I · 2026-09-06 — що показало підключення каталогу
