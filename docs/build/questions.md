...
| Q-160 | SCOPE | `S-21` недосяжний: формули шаблону і формули методологій — два різні конвеєри, і явного маршруту «перерахуй формули шаблону» в контракті немає ✎ сам `S-21` закрив `W10.2` (зелений на інтерактивному конвеєрі); відкритим лишається маршрут — див. виправлення в тілі запису, `D2-338`/`D2-339` | OPEN |
