<#
.SYNOPSIS
    Прогін сценаріїв 1, 5, 9, 15 автоматично (Q-222: коментар раніше
    називав 4 і 6, яких тут ніколи не було). Решта — вручну: вони
    потребують перезавантаження або відсутності прав.
.NOTES
